...
static const char zuk_mac_prefix[] = { 0x34, 0x80, 0xb3 };
...
generate_random:
    memcpy(wlan_addr, zuk_mac_prefix, sizeof(zuk_mac_prefix));
    ...
    for (i = sizeof(zuk_mac_prefix) / sizeof(zuk_mac_prefix[0]); i < MAC_ADDR_SIZE; i++) {
